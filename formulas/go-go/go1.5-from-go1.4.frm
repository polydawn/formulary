...
## which uses the go1.4 release for linux to *build* the go1.5 binaries for linux.
##
...
inputs:
	...
	"/app/go/":
		type: "tar"
		hash: "b5UGkGX0DbWc7sGLaH5DZgiZrBHr1pRSlSdbKOe7laJ9Du8C8GGc62mVrUk9AHI9"
		silo: "https://storage.googleapis.com/golang/go1.4.linux-amd64.tar.gz"
	"/task/go-src/":
		type: "tar"
